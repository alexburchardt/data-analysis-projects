...
def reverse_characters(string):
    ...
    if isinstance(string,int):
        result="".join(reversed(list(str(string))))
        return int(result)
print (reverse_characters(12345))
print (reverse_characters("Launchcode"))
...
def reversed_list(list_to_change):
    reversed_items=[reverse_characters(string) for string in list_to_change]
