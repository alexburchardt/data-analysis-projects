...
# b. Use a second loop to query the user for the number of astronauts (up to a maximum of 7). Validate the entry.
  ...
  while num_of_astronauts <=1 or num_of_astronauts>7:
    num_of_astronauts int(input("Please enter the number of astronauts"))
...
print (f"The shuttle gained an altitude of {shuttle_altitude}km and has {fuel_level}kg of fuel left.")
